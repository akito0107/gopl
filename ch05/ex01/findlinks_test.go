...
func Test_run(t *testing.T) {
	in := `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
<a href='http://www.amazon.com/dp/020161586X?tracking_id=disfordig-20'>The Practice of Programming</a>.
	...
	out := `http://www.informit.com/store/go-programming-language-9780134190440
...
`
	...
	run(stdin, stdout)
	if bytes.Compare([]byte(out), stdout.Bytes()) != 0 {
		t.Fatal("not matched")
	}
}
